...
public class O_D_Array_3_22_2017_Tester{
   public static void main (String [] args){
      //1.  Declarations
      int [] intList = {10, 5, 20, 25, 15};
      String [] names = {"Basem", "Dustin", "Landon", "Martin", "Jose","Wei", "Mathew"};
      String [] names2 = {"Ashley","Justin","Adam"};
      //2.  Create an object of O_D_Array_3_22_2017 class
      O_D_Array_3_22_2017 one = new O_D_Array_3_22_2017();
