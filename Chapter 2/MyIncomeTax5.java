...
public class MyIncomeTax5 {
   ...
   public static void computeMarriedFilingJointly() {
      ...
      // they are suppose to be in
      //**********************************
      if (annualIncome <= 18550) {
		   taxDue += annualIncome * 0.10;
	   } 
      else if ((annualIncome > 18551) && (annualIncome <= 75300)) {
			taxDue += 1855 + (annualIncome - 18550) * 0.15;
		} 
      else if ((annualIncome > 75301) && (annualIncome <= 151900)) {
			taxDue += 10367.50 + (annualIncome - 75300) * 0.25; 
		} 
      else if ((annualIncome > 151901) && (annualIncome <= 231450)) {
			taxDue += 29517.50 + (annualIncome - 151900) * 0.28;		
      } 
      else if ((annualIncome > 231451) && (annualIncome <= 413350)) {
			taxDue += 51791.50 + (annualIncome - 231450) * 0.33;		
      } 
      else if ((annualIncome > 413351) && (annualIncome <= 466950)) {
			taxDue += 111818.50 + (annualIncome - 413350) * 0.35;
 		} 
      else if (annualIncome >= 466951) {
			taxDue += 130578.50 + (annualIncome - 466950) * 0.396;
      }
   ...
   public static void computeMarriedFilingSeparately() {
      ...
      else if ((annualIncome > 37651) && (annualIncome <= 75950)) {
			taxDue += 5183.75 + (annualIncome - 37650) * 0.25; 
		} 
      else if ((annualIncome > 75951) && (annualIncome <= 115725)) {
			taxDue += 18558.75 + (annualIncome - 91150) * 0.28;		
      } 
      else if ((annualIncome > 115726) && (annualIncome <= 206675)) {
			taxDue += 46278.75 + (annualIncome - 190150) * 0.33;		
      } 
      else if ((annualIncome > 206676) && (annualIncome <= 233475)) {
			taxDue += 119934.75 + (annualIncome - 413350) * 0.35;
 		} 
      else if (annualIncome >= 233476) {
			taxDue += 120529.75 + (annualIncome - 415050) * 0.396;
      }
